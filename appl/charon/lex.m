Lex: module
{
	...
	Aabbr, Aaccept, Aaccept_charset, Aaccesskey, Aaction,
		Aalign, Aalink, Aalt, Aarchive, Aaria_hidden, Aaria_label, Aautocomplete, Aautofocus, Aaxis,
		...
		Acolor, Acols, Acolspan, Acompact, Acontent, Acoords, Acrossorigin,
		Adata, Adatafld, Adataformatas, Adatapagesize, Adatasrc,
		Adatetime, Adeclare, Adecoding, Adefer, Adir, Adisabled,
		Aenctype, Aevent,
		Aface, Afor, Aframe, Aframeborder,
		Aheaders, Aheight, Ahref, Ahreflang, Ahspace, Ahttp_equiv,
		Aid, Aismap, Alabel, Alang, Alanguage, Alink, Alist, Aloading, Alongdesc, Alowsrc,
		...
		Aopen,
		Apattern, Aplaceholder, Aprofile, Aprompt, Areadonly, Arel, Arequired, Arev, Arole, Arows, Arowspan, Arules,
		Ascheme, Ascope, Ascrolling, Aselected, Ashape, Asize, Asizes,
		Aspan, Asrc, Asrcset, Astandby, Astart, Astep, Astyle, Asummary,
