...
[![Latest release](https://img.shields.io/github/v/release/infernode-os/infernode?sort=semver&display_name=tag&label=release)](https://github.com/infernode-os/infernode/releases/latest)
...
Every asset is published with a cosign bundle (`.pem` + `.sig`) and a signed `SHA256SUMS.txt`. See [Releases](https://github.com/infernode-os/infernode/releases) for the full history.
